...
from vlm2vec.data.eval_dataset.base_eval_dataset import AutoEvalPairDataset, add_metainfo_hook
from vlm2vec.data.utils.dataset_utils import load_hf_dataset, sample_dataset
from vlm2vec.data.utils.vision_utils import temporal_random_crop, process_video_frames, load_frames, qa_template
from vlm2vec.model.processor import VLM_VIDEO_TOKENS
import random
import cv2
