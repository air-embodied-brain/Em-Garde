...
from vlm2vec.data.dataset.base_pair_dataset import AutoPairDataset, add_metainfo_hook, RESOLUTION_MAPPING, MULTIMODAL_FEATURES
from vlm2vec.data.eval_dataset.video_classification_utils import VIDEOCLS_LABEL_MAPPING, DATASET_INSTRUCTION
from vlm2vec.data.utils.vision_utils import save_frames, load_frames, sample_frames
from vlm2vec.data.utils.dataset_utils import sample_dataset
...
def load_ssv2_dataset(model_args, data_args, training_args, *args, **kwargs):
    DATASET_HF_PATH = 'VLM2Vec/SmthSmthV2'
