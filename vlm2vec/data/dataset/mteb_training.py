...
from vlm2vec.data.dataset.base_pair_dataset import AutoPairDataset, add_metainfo_hook
from vlm2vec.prompt.base_prompt import AutoPrompt
from vlm2vec.text_utils.normalize_text import normalize
from vlm2vec.prompt.sfr import CLASSIFICATION_NAME2LABELS
from vlm2vec.text_utils.basic_utils import print_rank, print_master
