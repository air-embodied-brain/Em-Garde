...
from vlm2vec.model.vlm_backbone.qwen2_5_vl import Qwen2_5_VLProcessor


class LamRAQwen25VL(nn.Module):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.processor = Qwen2_5_VLProcessor.from_pretrained(model_name, size=size, **kwargs)
        ...
        **kwargs
        ...
        if inputs_embeds is None:
            ...
            if has_image:
                ...
                pixel_values = pixel_values.type(self.base.visual.dtype)
