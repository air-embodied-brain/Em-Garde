...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(self, hidden_states: torch.Tensor, grid_thw: torch.Tensor) -> torch.Tensor:
        ...
        # @ruimeng, to resolve the AssertionError: Input and cos/sin must have the same dtype, got torch.bfloat16 and torch.float32
        #       at modeling_qwen2_5_vl.py", line 169, in apply_rotary_pos_emb_flashatt, output = apply_rotary_emb(tensor_, cos, sin).type_as(tensor):
